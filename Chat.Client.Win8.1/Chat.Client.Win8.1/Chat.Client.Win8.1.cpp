...
// Chat.Client.Win8.1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChatClientWin81App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CChatClientWin81App

CChatClientWin81App::CChatClientWin81App()
{
...
// Единственный объект CChatClientWin81App

CChatClientWin81App theApp;


// инициализация CChatClientWin81App

BOOL CChatClientWin81App::InitInstance()
{
